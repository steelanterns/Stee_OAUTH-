package stee.security.fortify.config;
...
import stee.security.fortify.service.OidcUserInfoService;
...
//                .oidc(withDefaults())
                ...
                .tokenEndpoint(tokenendpoint -> tokenendpoint
                        .accessTokenResponseHandler(new CustomAccessTokenResponseHandler())); //for the custom access token
        http
